...
- **`TracciatoreLogo`** (`ui/sfx/TracciatoreLogo.java`, **1469 righe** — il file più grande della UI): non è un semplice effetto ma una **pipeline di elaborazione immagine** per tracciare e animare il contorno di un logo. Estesamente documentata in un commento di testa (righe 18-90+) in 7 fasi:
