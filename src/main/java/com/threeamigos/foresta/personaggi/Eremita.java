...
public class Eremita extends PersonaggioBase implements Personaggio {
	...
	public double getMoltiplicatoreContrattazione() {
		return Costanti.EREMITA_MOLTIPLICATORE_CONTRATTAZIONE;
	}

	@Override
	public String getNoteMoltiplicatoreContrattazione() {
		return Costanti.EREMITA_MOLTIPLICATORE_CONTRATTAZIONE_NOTA;
	}
	...
	public double getMaxStatistica(TipoAttributo tipoAttributo) {
		switch (tipoAttributo) {
			case FORZA:
				return Costanti.EREMITA_MAX_FORZA;
			case DESTREZZA:
				return Costanti.EREMITA_MAX_DESTREZZA;
			case COSTITUZIONE:
				return Costanti.EREMITA_MAX_COSTITUZIONE;
			case INTELLIGENZA:
				return Costanti.EREMITA_MAX_INTELLIGENZA;
			case SAGGEZZA:
				return Costanti.EREMITA_MAX_SAGGEZZA;
			case CARISMA:
				return Costanti.EREMITA_MAX_CARISMA;
			case FORTUNA:
				return Costanti.EREMITA_MAX_FORTUNA;
			default:
