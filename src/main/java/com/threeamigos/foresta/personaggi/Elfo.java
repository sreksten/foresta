...
public class Elfo extends PersonaggioBase implements Personaggio {
	...
	public double getMoltiplicatoreContrattazione() {
		return Costanti.ELFO_MOLTIPLICATORE_CONTRATTAZIONE;
	}

	@Override
	public String getNoteMoltiplicatoreContrattazione() {
		return Costanti.ELFO_MOLTIPLICATORE_CONTRATTAZIONE_NOTA;
	}
	...
	public double getMaxStatistica(TipoAttributo tipoAttributo) {
		switch (tipoAttributo) {
			case FORZA:
				return Costanti.ELFO_MAX_FORZA;
			case DESTREZZA:
				return Costanti.ELFO_MAX_DESTREZZA;
			case COSTITUZIONE:
				return Costanti.ELFO_MAX_COSTITUZIONE;
			case INTELLIGENZA:
				return Costanti.ELFO_MAX_INTELLIGENZA;
			case SAGGEZZA:
				return Costanti.ELFO_MAX_SAGGEZZA;
			case CARISMA:
				return Costanti.ELFO_MAX_CARISMA;
			case FORTUNA:
				return Costanti.ELFO_MAX_FORTUNA;
			default:
