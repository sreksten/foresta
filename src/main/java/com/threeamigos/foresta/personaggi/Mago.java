...
public class Mago extends PersonaggioBase implements Personaggio {
	...
	public double getMoltiplicatoreContrattazione() {
		return Costanti.MAGO_MOLTIPLICATORE_CONTRATTAZIONE;
	}

	@Override
	public String getNoteMoltiplicatoreContrattazione() {
		return Costanti.MAGO_MOLTIPLICATORE_CONTRATTAZIONE_NOTA;
	}
	...
	public double getMaxStatistica(TipoAttributo tipoAttributo) {
		switch (tipoAttributo) {
			case FORZA:
				return Costanti.MAGO_MAX_FORZA;
			case DESTREZZA:
				return Costanti.MAGO_MAX_DESTREZZA;
			case COSTITUZIONE:
				return Costanti.MAGO_MAX_COSTITUZIONE;
			case INTELLIGENZA:
				return Costanti.MAGO_MAX_INTELLIGENZA;
			case SAGGEZZA:
				return Costanti.MAGO_MAX_SAGGEZZA;
			case CARISMA:
				return Costanti.MAGO_MAX_CARISMA;
			case FORTUNA:
				return Costanti.MAGO_MAX_FORTUNA;
			default:
