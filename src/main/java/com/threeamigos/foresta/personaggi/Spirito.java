...
public class Spirito extends PersonaggioBase implements Personaggio {
	...
	public double getMoltiplicatoreContrattazione() {
		return Costanti.SPIRITO_MOLTIPLICATORE_CONTRATTAZIONE;
	}

	@Override
	public String getNoteMoltiplicatoreContrattazione() {
		return Costanti.SPIRITO_MOLTIPLICATORE_CONTRATTAZIONE_NOTA;
	}
	...
	public double getMaxStatistica(TipoAttributo tipoAttributo) {
		switch (tipoAttributo) {
			case FORZA:
				return Costanti.SPIRITO_MAX_FORZA;
			case DESTREZZA:
				return Costanti.SPIRITO_MAX_DESTREZZA;
			case COSTITUZIONE:
				return Costanti.SPIRITO_MAX_COSTITUZIONE;
			case INTELLIGENZA:
				return Costanti.SPIRITO_MAX_INTELLIGENZA;
			case SAGGEZZA:
				return Costanti.SPIRITO_MAX_SAGGEZZA;
			case CARISMA:
				return Costanti.SPIRITO_MAX_CARISMA;
			case FORTUNA:
				return Costanti.SPIRITO_MAX_FORTUNA;
			default:
